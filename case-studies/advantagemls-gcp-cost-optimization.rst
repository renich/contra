===================================================================
$45k/Year Cloud Cost Optimization & Zero-Downtime OS Modernization
===================================================================
...
Refactored legacy monolithic Terraform configurations into clean, modular OpenTofu code, providing reproducible infrastructure baselines and drift detection.

Resource Lifecycle Automation
-----------------------------

Implemented automated snapshot lifecycle policies, ephemeral instance scheduling for non-production environments, and right-sized compute machine families based on historical p99 utilization metrics.

Edge Caching & Ingress Optimization
-----------------------------------

Re-architected Content Delivery Network (CDN) edge rules for high-frequency media assets, slashing origin server load and expensive cloud network egress fees.

Rolling In-Place OS Modernization
---------------------------------

Executed a phased, zero-downtime migration from CentOS 7/8 directly to CentOS Stream 10 across production clusters using canary node deployment and automated failover.
